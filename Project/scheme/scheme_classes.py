...
class Frame:
    ...
    def lookup(self, symbol):
        ...
        while check_frame is not None:
            if symbol in check_frame.bindings:
                return check_frame.bindings[symbol]
            check_frame=check_frame.parent
        # END PROBLEM 1
    ...
    def make_child_frame(self, formals, vals):
        ...
        rest_1,rest_2=formals,vals
        while rest_1 is not nil or rest_2 is not nil:
            child_frame.define(rest_1.first,rest_2.first)
            rest_1,rest_2=rest_1.rest,rest_2.rest
        return child_frame
        # END PROBLEM 8
